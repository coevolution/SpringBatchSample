...
import org.example.common.SkipCheckingListener;
import org.example.skip.SkippableExceptionDuringProcess;
import org.example.test.context.SpringJUnitConfig;
...
import static org.example.common.SkipCheckingListener.*;
 ...
 */
@SpringJUnitConfig(locations = { "/org/springframework/batch/samples/skip/job/skip-job-launcher-context.xml" })
class SkippableExceptionDuringProcessTests {
    ...
    void testSkippableExceptionDuringProcess() throws Exception {
        ...
        ApplicationContext context = new AnnotationConfigApplicationContext(
                SkippableExceptionDuringProcess.class);
    ...
    private void validateLaunchWithSkips(JobExecution jobExecution) {
        ...
        Assertions.assertEquals(1, getProcessSkips());
